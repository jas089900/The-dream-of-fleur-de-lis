...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        pred_betas = pred_betas[:, :10]  # 截断到10个shape参数
        print("DEBUG pred_betas.shape:", pred_betas.shape)
    ...
    output_obj_path = str(Path(outfile).with_suffix('')) + '_mesh.obj'
    save_obj(output_obj_path, pred_vertices, smpl.faces)
    print(f"✅ OBJ文件已保存至: {output_obj_path}")
